...
var TouchSlide = function(a) {
    ...
    // M = 300
    P = n;
	var NBA = function(num){
        // console.log('点击选项触发函数')
        abc++
        var nba = r + 1
        r = nba
        console.log('r的值1',r,num)
    }
    if (0 == p && (p = n), v) {
        p = n,
        o = o[0],
    ...
    X = function(a) {
        ...
        case "left":
            ...
            // }else{
                ...
                W( - r * M, s),
            // }
            // console.log('r第几个,M设备宽度，s,p题标元素个数',r,M,s,p)
            // console.log('a是什么',a)
            // W( -1750, s),
            x = r;
            break;
    ...
    // CC = function(){
    //     console.log('函数CC')
    //     m.addEventListener(I,yy,!1)
    // }
    $ = function(a) {
        0 != D && (
            a.preventDefault(), 
            O || (
                Math.abs(D) > M / 10 && (D > 0 ? r--:r++), X(!0), u && (
                    y = setInterval(
                        function() {
                            r++,
                            X()
                ...
                ), m.removeEventListener(J, Z, !1), m.removeEventListener(K, $, !1)
            )
    };
